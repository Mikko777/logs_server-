...
-- Kontti laitto
RegisterServerEvent("esx:konttilaittoalert")
AddEventHandler("esx:konttilaittoalert", function(name,plate,item,amount)
  sendToDiscord3('Takakontti',name.." laittoi takakonttiin "..plate.." "..item.." määrän ".. amount,Config.green)
end)

-- Kontti otto
RegisterServerEvent("esx:konttiottoalert")
AddEventHandler("esx:konttiottoalert", function(name,plate,item,amount)
  sendToDiscord3('Takakontti',name.." otti takakontista "..plate.." "..item.." määrällä ".. amount,Config.red)
end)
...
-- Varasto (Laitto)
RegisterServerEvent("esx:kaappilaitto")
AddEventHandler("esx:kaappilaitto", function(name,job,weaponName)
  sendToDiscord3('Uusi Tapahtuma (Kaappi laitto)',name.." | laittoi kaappiin | "..job.." | "..weaponName.." | Kello: "..os.date("%X"),Config.green)
end)

-- Varasto (Otto)
RegisterServerEvent("esx:kaappiotto")
AddEventHandler("esx:kaappiotto", function(name,job,weaponName)
...
AddEventHandler("esx_property:putItem", function(name,item,amount)
  sendToDiscord6('Uusi Tapahtuma (Asunto laitto)',"Pelaaja: " ..name.. " | Laittoi asuntoon: " ..item.. " | Määrä: " ..amount.. " | Kello: "..os.date("%X"),Config.green)
end)

-- Asunto (Otto)
RegisterServerEvent("esx_property:getItem")
AddEventHandler("esx_property:getItem", function(name,item,amount)
  sendToDiscord6('Uusi Tapahtuma (Asunto otto)',"Pelaaja: " ..name.. " | Otti asunnosta: " ..item.. " | Määrä: " ..amount.. " | Kello: "..os.date("%X"),Config.red)
end)
...
AddEventHandler("esx-qalle-sellvehicles:buyVehicle", function(data)
	msg1 = data.msg1
	msg2 = data.msg2
	msg3 = data.msg3
